    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 main-layout" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          {/* Header Actions */}
          <div className="flex items-center justify-between mb-6 dashboard-flex">
            <div className="dashboard-text-align">
            ...
            <button
              ...
              className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg font-medium transition-colors duration-200 dashboard-button-content"
            >
              <RefreshCw size={16} className="dashboard-mr-2" />
              {t('orders.refresh')}
            </button>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mb-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 dashboard-text-align">
              {/* Search */}
              <div className="relative">
                ...
                <input
                  ...
                  className={`
                    ...
                    transition-colors duration-200 dashboard-input-padding
                  `}
                  dir={isRTL ? 'rtl' : 'ltr'}
                />
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
            {currentOrders.length === 0 ? (
              ...
              <>
                ...
                <div className="hidden lg:grid gap-4 p-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 dashboard-text-align dashboard-grid-cols-8">
                ...
                {/* Table Header - Mobile */}
                <div className="lg:hidden grid grid-cols-3 gap-4 p-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 dashboard-text-align">
                  <div className="font-medium text-gray-700 dark:text-gray-300">
                ...
                <div className="divide-y divide-gray-200 dark:divide-gray-600">
                  {currentOrders.map((order) => {
                    ...
                    return (
                      <div key={order.id}>
                        {/* Desktop Layout */}
                        <div className="hidden lg:grid gap-4 p-4 dashboard-text-align dashboard-grid-cols-8">
                          {/* Order Number */}
                          <div className="flex items-center dashboard-content-reverse">
                            <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900/20 rounded-lg flex items-center justify-center">
                              <ShoppingCart size={16} className="text-blue-600 dark:text-blue-400" />
                            </div>
                            <div className="dashboard-ml-3">
                          ...
                          <div className="flex items-center">
                            <select
                              ...
                              className={`
                                ...
                                disabled:opacity-50 disabled:cursor-not-allowed dashboard-text-align
                          ...
                          <div className="flex items-center dashboard-content-reverse">
                            ...
                            <span className="text-sm text-gray-600 dark:text-gray-400 dashboard-ml-2">
                              {order.order_items?.length || 0} {t('orders.itemsCount')}
                            </span>
                          </div>

                          {/* Actions */}
                          <div className="flex items-center dashboard-content-reverse dashboard-space-x-2">
                            <button
                        ...
                        {/* Mobile Layout */}
                        <div className="lg:hidden grid grid-cols-3 gap-4 p-4 dashboard-text-align">
                          {/* Order & Customer Info */}
                          ...
                          {/* Book Details */}
                          <div className="flex items-center dashboard-content-reverse dashboard-space-x-3">
                            {firstBook ? (
                              <div className="w-10 h-12 bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden flex items-center justify-center flex-shrink-0">
                                {firstBook.cover_image_url ? (
                                  <img
                                    src={firstBook.cover_image_url}
                                    alt={firstBook.title}
                                ...
                                <div className="w-full h-full flex items-center justify-center" style={{ display: firstBook.cover_image_url ? 'none' : 'flex' }}>
                                  <Package size={16} className="text-gray-400" />
                                </div>
                              </div>
                            ) : (
                          ...
                          <div className="flex flex-col space-y-2">
                            <select
                              ...
                              className={`
                                px-2 py-1 rounded-lg text-xs font-medium border-0 cursor-pointer
                                transition-all duration-200 focus:ring-2 focus:ring-blue-500 focus:outline-none
                                disabled:opacity-50 disabled:cursor-not-allowed dashboard-text-align dashboard-mobile-status
                                ${getStatusColor(order.status)}
                                ${updatingStatus === order.id ? 'animate-pulse' : ''}
                              `}
                              style={{ 
                            ...
                            <div className="flex items-center dashboard-content-reverse dashboard-space-x-2 dashboard-mobile-actions">
                              <button
                                onClick={() => handleViewOrder(order.id)}
          ...
          {/* Pagination */}
          {totalPages > 1 && (
            <div className="flex items-center justify-between mt-6 dashboard-flex">
              <div className="text-sm text-gray-600 dark:text-gray-400 dashboard-text-align">
              ...
              <div className="flex items-center dashboard-content-reverse dashboard-space-x-2">
                <button
                  ...
                  className="flex items-center px-3 py-2 text-sm text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 dashboard-button-content"
                >
                  <ChevronLeft size={16} className="dashboard-mr-1" />
                  {t('common.previous')}
                </button>
                
                <div className="flex dashboard-content-reverse dashboard-space-x-1">
                ...
                >
                  {t('common.next')}
                  <ChevronRight size={16} className="dashboard-ml-1" />
                </button>
              </div>
            </div>
          )}
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 p-6 w-full max-w-md mx-4 transform transition-all duration-300 ease-out">
            ...
            <button
              onClick={cancelDeleteOrder}
              className={`absolute top-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors duration-200 ${isRTL ? 'left-4' : 'right-4'}`}
            >
              <X size={20} />
            </button>

            {/* Modal Header */}
            <div className="flex items-center mb-4 dashboard-content-reverse">
              <div className="w-12 h-12 bg-red-100 dark:bg-red-900/20 rounded-full flex items-center justify-center dashboard-mr-4">
            ...
            {/* Modal Body */}
            <div className="mb-6 dashboard-text-align">
            ...
            {/* Modal Footer */}
            <div className="flex items-center justify-end dashboard-content-reverse dashboard-space-x-3">
              <button
                onClick={cancelDeleteOrder}
                disabled={deleting}
              ...
              <button
                ...
                disabled={deleting}
                className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center dashboard-button-content"
              >
                {deleting ? (
                  <>
                    <RefreshCw size={16} className="animate-spin dashboard-mr-2" />
                    {t('orders.deleting')}
                  </>
                ) : (
                  <>
                    <Trash2 size={16} className="dashboard-mr-2" />
